...
fig_dir<- "../../../Figures/Data-validation/"
```
...
reads_filtering_plt<- ggplot(m_reads2,aes(x = reorder(sam_name, as.numeric(sam_name)), y=reads, fill=stage))+
  ...
  theme(axis.text.x = element_blank(),
        ...
        axis.text.y = element_text(size = 12, angle = 0, hjust = 1, vjust = 0.5, face = "plain", ))+
...
ggsave(paste(fig_dir, "reads_filtering.png", sep=""), reads_filtering_plt,units = "mm",
...
ggsave(paste(fig_dir, "Kraken2_barplot.svg", sep=""), krk_comm_plt,units = "mm", height = 210, width = 297, dpi=600)
```
